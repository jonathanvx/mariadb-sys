...
SELECT '1.5.2' AS sys_version, 
        version() AS mysql_version;-- Copyright (c) 2014, 2015, Oracle and/or its affiliates. All rights reserved.
--
-- This program is free software; you can redistribute it and/or modify
-- it under the terms of the GNU General Public License as published by
-- the Free Software Foundation; version 2 of the License.
...
BEGIN
    ...
    -- Workaround for MariaDB to keep code changes as little as possible.
...
CREATE  PROCEDURE get_optimizer_switches(
    )
    COMMENT '
             Description
             -----------
